                ...
                <div className="bg-background rounded-3xl p-8 shadow-sm border border-border relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start gap-6 relative z-10">
                        ...
                        <div className="flex gap-3 w-full md:w-auto">
                            ...
                            <Button asChild className="flex-1 md:flex-none bg-primary hover:bg-primary/80 text-background px-10 h-14 rounded-2xl shadow-lg shadow-primary/20 text-lg font-bold">
