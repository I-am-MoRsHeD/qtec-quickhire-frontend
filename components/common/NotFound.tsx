...
export function NotFound() {
    ...
    return (
        <div className="min-h-screen w-full bg-linear-to-b from-primary/10 to-background overflow-hidden relative flex flex-col items-center justify-center p-4">
            ...
            <div className="relative z-10 max-w-3xl w-full text-center">
                ...
                >
                    <h1 className="text-[150px] md:text-[220px] font-black leading-none text-transparent bg-clip-text bg-linear-to-br from-primary to-primary/70 select-none drop-shadow-sm">
                        404
                    </h1>
                ...
                >
                    ...
                    >
                        <motion.button
                            ...
                            className="group relative px-8 py-4 bg-primary text-background rounded-full font-bold text-lg shadow-lg shadow-primary overflow-hidden flex items-center gap-2"
                            onClick={() => router.push("/")}
                        >
