...
export default function AllFilters({ filterOptions }: IProps) {
        ...
        {Object.entries(paramFilters)?.filter((filter) => filter[1] !== "")
          ?.length > 0 && (
            <Button
              ...
              className="text-sm text-primary hover:text-primary hover:bg-pink-50"
            >
          ...
          >
            <div className="mt-4 p-4 border rounded-lg bg-gray-50">
              ...
              <div className="mt-4 flex justify-end">
                ...
                <Button
                  className="mr-2 bg-primary hover:bg-primary/90 text-background"
